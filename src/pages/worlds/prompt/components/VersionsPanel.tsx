...
export default function GenerateVersionsPanel({
  ...
  return (
    <div className="relative">
      {/* Below the nav and the tab row this panel now lives under (48 + 44), rather than at the
          top of the sheet it used to be in. */}
      <div className="sticky top-23 z-20 -mx-4 mb-3 flex h-9 items-center justify-end border-b border-rose-line/70 bg-paper/95 px-6 backdrop-blur">
